...
class EticaretContainer extends StatefulWidget {
  String? baslik;
  String? id;
  String? marka;
  String? model;
  ...
  @override
  State<EticaretContainer> createState() => _EticaretContainerState(
      site: site,
      id: id,
      img: img,
      baslik: baslik,
...
class _EticaretContainerState extends State<EticaretContainer> {
  String? baslik;
  String? id;
  String? img;
